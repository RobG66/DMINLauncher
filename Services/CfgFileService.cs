...
{
    public static class CfgFileService
    {
        public static Dictionary<string, Dictionary<string, string>> ReadFile(string filePath)
        {
        ...
        {
            var sections = ReadFile(filePath);
            return sections.TryGetValue(sectionName, out var section) ? section : null;
        }

        public static void WriteFile(string filePath, Dictionary<string, Dictionary<string, string>> sections)
        {
